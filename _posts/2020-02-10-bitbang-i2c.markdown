...
descritpion: "Write simple code to implement the two wire protocol (I2C) with little program space for Arduino, ATtiny85 and other microcontrollers."
date:   2020-02-10 20:20:00 +0000
categories: attiny85 i2c attiny10
---
